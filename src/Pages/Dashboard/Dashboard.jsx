...
const Dashboard = () => {
  const userName = "ব্যবহারকারীর নাম";
      ...
      <div className="mx-auto max-w-3xl py-6">
          ...
          <div className="relative flex items-start justify-between">
            <div>
              ...
              <p className="mt-2 text-[12px] text-white/80">
                বকেয়া ঋণ: <span className="font-semibold">১,০০,০০০ টাকা</span>
              </p>
            </div>
        ...
        <div className="mt-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <button className="flex items-center gap-3 rounded-lg bg-[#1B2B8F] text-white px-4 py-3 shadow-sm hover:opacity-95 transition">
